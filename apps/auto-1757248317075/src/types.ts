...
export type GameMessage = 
  ...
  | { type: 'ROOM_LEFT'; roomId: string; playerId: string }
  | { type: 'GAME_STARTED'; room: Room }
  | { type: 'MOVE_MADE'; position: Position; player: Player; board: Board }
  | { type: 'GAME_ENDED'; winner: 'black' | 'white' | 'draw'; winCondition?: WinCondition }
